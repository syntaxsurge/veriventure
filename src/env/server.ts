...
const serverSchema = z.object({
  ...
  DKG_MAX_RETRIES: z.coerce.number().int().positive().default(120),
  DKG_POLL_FREQUENCY: z.coerce.number().int().positive().default(2),
  DKG_PUBLISH_EPOCHS: z.coerce.number().int().positive().default(2),
  DKG_MIN_FINALITY_CONFIRMATIONS: z.coerce.number().int().nonnegative().default(0),
