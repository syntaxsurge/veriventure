...
1. **On-screen:** Navigate to `/dashboard`. Point to the wallet chip or profile section showing the connected address, then point to the quick-start tiles or checklist (for example actions like Create Invoice, Mint Credential, or Generate Deck).
